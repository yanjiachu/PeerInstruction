...
Page({
    ...
    goToOriginalQuestion(event) {
        ...
        const questionValue = encodeURIComponent(JSON.stringify(this.data.items[index]));
        wx.navigateTo({
            url: '../TeacherQBDisplay/QBDisplay?question=' + questionValue
        });
    },
    onShow() {
